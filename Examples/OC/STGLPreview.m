...
- (void)renderSampleBuffer:(CMSampleBufferRef)sampleBuffer {
    GLuint texture = [self textureFromSampleBuffer:sampleBuffer];
...
- (BOOL)drawFrameWithTexture:(GLuint)texture
{
    ...
    static const GLfloat textureVerticesMirrored[] = {
        1.0f, 1.0f,
        0.0f, 1.0f,
        1.0f,  0.0f,
        0.0f,  0.0f,
    ...
    glVertexAttribPointer(ATTRIB_TEXTUREPOSITON, 2, GL_FLOAT, 0, 0, _mirrored ? textureVerticesMirrored : textureVertices);
